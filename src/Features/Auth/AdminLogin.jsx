    ...
    <>
      ...
      <div className="parent_container" style={{ height: "90vh" }}>
        <div className="d-flex justify-content-center align-items-center w-50">
          <div id="admin-row" className="row mx-4 w-100">
            <div
              ...
              <form onSubmit={handleSubmit} method="post">
                ...
                <div className="form my-3">
                  <input
                    ...
                    type="text"
                    className="form-control form-control-auth m-0"
                    id="userName"
                    name="username"
                    placeholder="Username or email"
                  />
                  <span className="adminInputs">Try: test@test.com</span>
                  ...
                  <input
                    ...
                    name="password"
                  />
                  <span className="adminInputs">Try: 123</span>
                </div>
